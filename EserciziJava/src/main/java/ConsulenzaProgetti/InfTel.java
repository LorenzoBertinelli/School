...
import static ConsulenzaProgetti.Persona.ANNOATTUALE;

public class InfTel extends Tecnico {
    private static final double COSTO_ORARIO = 60.0;
    private int oreLavorate;

    public InfTel(int oreLavorate, int codice, String nome, String cognome, int annoInizio, boolean interno) {
